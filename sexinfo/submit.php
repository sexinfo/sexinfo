<?php
	...
	$page->add('<center><div id="questions"><br /><li>Before submitting a question, please try searching your question or browse the <a href="http://www.soc.ucsb.edu/sexinfo/article/frequently-asked-questions"><b><font size="3"><br />Frequently Asked Questions</font></b></a> to see if it has been already answered. 		
	...
	$page->add('<center><h1>Ask the Sexperts</h1><br /><br /> ');
	$page->add('
	
	
	<div id="questions" style="width:650px"><br />
	<p><b><font size="3">We\'re sorry but the Sexperts are away for Winter break, we\'ll be back January.</font></b></p>
	<br /><li style="width:400px">Please try searching your question or browse the <a href="http://www.soc.ucsb.edu/sexinfo/article/frequently-asked-questions"><b><font size="2">Frequently Asked Questions</font></b></a> to see if it has been already answered. 		
