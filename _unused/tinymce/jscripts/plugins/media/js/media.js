(function() {
	...
	if (url = tinyMCEPopup.getParam("media_external_list_url"))
		document.write('<script language="javascript" type="text/javascript" src="../../../../../../core/tinymce/jscripts/plugins/media/js/' + tinyMCEPopup.editor.documentBaseURI.toAbsolute(url) + '"></script>');
