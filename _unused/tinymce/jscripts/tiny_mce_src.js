...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
		...
		renderHTML : function() {
			...
			if (s.image)
				h += '<img class="mceIcon" src="../../../core/tinymce/jscripts/' + s.image + '" alt="' + DOM.encode(s.title) + '" />' + l;
			else
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			if (s.document_base_url != tinymce.documentBaseURL)
				t.iframeHTML += '<base href="../../../core/tinymce/jscripts/' + t.documentBaseURI.getURI() + '" />';
			...
			if (!isGecko || !/Firefox\/2/.test(navigator.userAgent)) {
				for (i = 0; i < t.contentCSS.length; i++)
					t.iframeHTML += '<link type="text/css" rel="stylesheet" href="../../../core/tinymce/jscripts/' + t.contentCSS[i] + '" />';
